...
export default function OurFeatures() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 font-sans bg-white relative z-20">
      {/* Header */}
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-stretch lg:h-[550px]">
        ...
        <div className="lg:w-[22%] flex flex-col py-2">
        ...
        {/* Middle Column: Image */}
        <div className="lg:w-[38%] h-[300px] lg:h-full">
          <img
        ...
        <div className="lg:w-[40%] flex flex-col gap-3 lg:h-full pr-1">
