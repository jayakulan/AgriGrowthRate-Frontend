  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col xl:flex-row gap-4 mb-8 xl:items-center w-full">
        ...
        {/* Filter control bar */}
        <div className="bg-white border border-[#e4e6df] rounded-2xl p-3 md:p-4 flex flex-col md:flex-row gap-4 items-center shadow-sm shrink-0">
          <div className="flex flex-wrap gap-2">
            ...
            <button className="flex items-center justify-center gap-2 bg-[#f4f5f0] border border-[#e4e6df] px-4 py-2 rounded-lg text-xs font-bold text-gray-700 hover:bg-gray-100 transition-colors shrink-0">
        ...
        <div className="flex items-center gap-4 shrink-0">
          {/* Pending */}
          <div className="bg-white border border-[#e4e6df] rounded-2xl p-3 flex items-center gap-4 shadow-sm min-w-[130px]">
                    ...
                    return (
                      <tr key={ord._id} className="text-xs text-gray-700 hover:bg-[#f9f9f6]/40 transition-colors">
                        ...
                        <td className="py-4 px-6">
                          <span className={`text-[9px] font-extrabold px-2 py-0.5 rounded-md tracking-wider uppercase ${ord.status === 'delivered' ? 'bg-[#edf4e2] text-[#4A6D2F]' :
