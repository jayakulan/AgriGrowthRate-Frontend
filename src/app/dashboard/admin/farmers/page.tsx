                ...
                {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 rounded-xl text-[10px] font-bold cursor-pointer flex items-center justify-center transition-all ${currentPage === page
                ...
                {totalPages > 5 && (
                  <>
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-xl text-[10px] font-bold cursor-pointer flex items-center justify-center transition-all ${currentPage === totalPages
                          ? 'bg-[#1e4d1e] text-white shadow-sm'
                          : 'bg-white border border-[#e4e6df] hover:bg-gray-50 text-gray-500'
                        }`}
                    >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#f0f2eb] pb-5">
              ...
              <div className="flex items-center bg-[#f4f5f0] p-1 rounded-full border border-[#e4e6df] shrink-0 self-start sm:self-auto">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold rounded-full transition-all cursor-pointer ${graphView === 'donut'
                      ? 'bg-[#1e4d1e] text-white shadow-sm'
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold rounded-full transition-all cursor-pointer ${graphView === 'bar'
                      ? 'bg-[#1e4d1e] text-white shadow-sm'
                      : 'text-gray-500 hover:text-gray-900'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold rounded-full transition-all cursor-pointer ${graphView === 'trend'
                      ? 'bg-[#1e4d1e] text-white shadow-sm'
                      : 'text-gray-500 hover:text-gray-900'
                    }`}
                >
                    ...
                    <div className="space-y-2 max-h-[190px] overflow-y-auto pr-1">
                      {districtList.map((district) => (
                        <div
                          ...
                          onMouseLeave={() => setHoveredSlice(null)}
                          className={`p-2 rounded-xl border transition-all cursor-pointer ${hoveredSlice?.name === district.name
              ...
              <div className="space-y-2 mb-6">
                {['farmer', 'consumer'].map((role) => (
                  <button
                    ...
                    className={`w-full py-3 rounded-xl transition text-xs font-bold uppercase tracking-wider cursor-pointer ${selectedUser.role === role
