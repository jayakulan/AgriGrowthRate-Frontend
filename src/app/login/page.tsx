        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="bg-white rounded-2xl border border-[#e4e6df] shadow-sm p-8">
            ...
            <button
              id="google-login-btn"
              type="button"
              className="w-full flex items-center justify-center gap-3 py-2.5 border border-[#d1d5db] rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
