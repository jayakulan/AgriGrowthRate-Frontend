  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-[#f9f9f6] flex flex-col justify-between">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2">
        ...
        {/* Left Side: Gorgeous tea garden farm image */}
        <div className="hidden lg:block relative w-full h-full min-h-[600px]">
          ...
          />
          {/* Subtle overlay overlay for high quality match */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#f9f9f6]/10" />
        </div>

        {/* Right Side: Login form and inputs */}
        <div className="flex items-center justify-center p-6 sm:p-12 lg:p-16">
          <div className="w-full max-w-[460px] bg-white border border-[#e4e6df] rounded-2xl p-8 sm:p-10 shadow-[0_4px_30px_rgba(0,0,0,0.03)]">
